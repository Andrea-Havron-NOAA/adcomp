...
global::ad_range::ad_range() : n(0), c(0) {}

global::ad_range::ad_range(ad_plain x, size_t n) : x(x), n(n), c(1) {}

global::ad_range::ad_range(Index idx, size_t n) : n(n) { x.index = idx; }

global::ad_range::ad_range(ad_plain x, size_t r, size_t c)
    : x(x), n(r * c), c(c) {}

global::ad_range::ad_range(Replay *x, size_t n, bool zero_check) : n(n), c(1) {
...
bool global::ad_range::identicalZero() { return !x.initialized(); }

bool global::ad_range::is_contiguous(Replay *x, size_t n) {
...
bool global::ad_range::all_zero(Replay *x, size_t n) {
...
bool global::ad_range::all_constant(Replay *x, size_t n) {
  for (size_t i = 0; i < n; i++) {
...
ad_plain global::ad_range::operator[](size_t i) const {
  ad_plain ans;
  ans.index = x.index + i;
  return ans;
}

Index global::ad_range::index() const { return x.index; }
...
ad_range operator/(ad_range x, ad_aug y) {
  return operator/(x, ad_range(y, 1));
}
ad_range operator/(ad_aug x, ad_range y) {
  return operator/(ad_range(x, 1), y);
}
